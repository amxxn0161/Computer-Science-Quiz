...
public class UniversityQ3 {

    public Button Q3WrongAns1;
    public Button Q3WrongAns2;
    public Button Q3CorrectAns;
    public Button Q3WrongAns3;
    ...
    public void CorrectAns(ActionEvent actionEvent) throws IOException {
        ...
        Window mainWindow = Q3CorrectAns.getScene().getWindow();
        Parent newRoot = FXMLLoader.load(getClass().getResource("UniversityQ4.fxml"));
    ...
    public void WrongAns1(ActionEvent actionEvent) throws IOException {
        ...
        Window mainWindow = Q3WrongAns1.getScene().getWindow();
        Parent newRoot = FXMLLoader.load(getClass().getResource("UniversityQ4.fxml"));
        mainWindow.getScene().setRoot(newRoot);
    }
    public void WrongAns2(ActionEvent actionEvent) throws IOException {
        ...
        Window mainWindow = Q3WrongAns2.getScene().getWindow();
        Parent newRoot = FXMLLoader.load(getClass().getResource("UniversityQ4.fxml"));
        mainWindow.getScene().setRoot(newRoot);
    }
    public void WrongAns3(ActionEvent actionEvent) throws IOException {
        ...
        Window mainWindow = Q3WrongAns3.getScene().getWindow();
        Parent newRoot = FXMLLoader.load(getClass().getResource("UniversityQ4.fxml"));
        mainWindow.getScene().setRoot(newRoot);
    }
}